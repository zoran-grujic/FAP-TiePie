...
class MyUi(Ui_MainWindow):
    ...
    def stabilizeProbe(self):
        ...
        if self.checkBox_StabProbePower.isChecked() and self.esp32.box.writable():
            ...
            self.doubleSpinBox_stabProbePowerOut.setValue(v + sgn*i)
...
"""
    ...
    def saveSettings(self, file='settings.zg.npy'):
        # TODO: needs a max number of saves per interval like 1s due multiple calls OnClose event.
        # print(f"{vars(self)=}")
        settingsToSave = []
        checkBoxesToSave=["checkBox_ProbeStabInvertPID"]
